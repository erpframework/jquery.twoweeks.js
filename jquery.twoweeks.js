    ...
    $.fn.twoweeks = function(){
        ...
        var weeks = 2;
      	var d = new Date();
    		...
    		var container = '<div class="twoweeks">';
    		
    		var day = d.getDay();
    		
    		container += '<div class="twoweeks-header"><span>Su</span><span>Mo</span><span>Tu</span><span>We</span><span>Th</span><span>Fr</span><span>Sa</span></div>';
    		
    		container += '<div class="twoweeks-week">';
    		var start = 0;
    		...
    		for(x=start; x<(7*weeks)+day+1; x++){
    			...
    			if((x+1)%7==0){
    				container+='</div><div class="twoweeks-week">';
    			}
